          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Pritam Kumar — a full-stack developer and B.Tech CSE
                (AI) student specializing in React, Node.js, and MongoDB. I
                build real-world applications that are fast, scalable, and
                user-friendly.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <a
                href="/resume/Pritam-Kumar-June_FullStack-Developer.pdf"
                download="Pritam-Kumar-FullStack-Developer-Resume.pdf"
              >
