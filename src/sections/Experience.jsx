const experiences = [
  ...
  {
    period: "2022 — 2026",
    role: "B.Tech — Computer Science & Engineering (AI Specialization)",
    company: "Technocrats Institute of Technology, Bhopal",
    description:
  ...
  },
  {
    ...
    company: "Raghunath Vidyamandir +2 School, Kalasan, Madhepura",
    description:
      "Completed senior secondary education with a focus on Science stream, building the academic foundation for engineering.",
    technologies: [],
    current: false,
  },
  {
    ...
    company: "Sri Basudeo High School, Nayatola, Madhepura",
    description:
      "Completed matriculation, laying the groundwork for a career in technology.",
    technologies: [],
    current: false,
  },
];
